function  [ndvi,mcari1,mtci,ndre,rdvi,ccci,cvi,ci_green,ci_g,ci_re]  = getVegetativeIndices(gre_image,red_image,nir_image,reg_image)
    %rgb=rgb_image;
    gre=gre_image;
    red=red_image;
    nir=nir_image;
